...
namespace Md{
    ...
    enum POS_LFETRIGHT{POSLEFT=0x01,POSRIGHT=0x02,POSLEFTRIGHT=0X03};
    Q_DECLARE_FLAGS(POSFLAG_LFETRIGHT, POS_LFETRIGHT)
    Q_DECLARE_OPERATORS_FOR_FLAGS(POSFLAG_LFETRIGHT)
